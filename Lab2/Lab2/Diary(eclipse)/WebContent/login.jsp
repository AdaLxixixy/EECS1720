<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page language="java" import="com.diary.model.User"%>
<%
...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading">日记管理系统</h2>
...
<p align="center" style="padding-top: 15px;">学习道路先苦后甜，加油！  <a href="#" target="_blank"></a></p>
      </form>
</div>
</body>
</html>